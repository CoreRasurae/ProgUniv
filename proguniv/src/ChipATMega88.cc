...
namespace ATMega88 {
	//Handle ATMega88/168 Fuses for Lock Bit Byte fuses
...
ChipATMega88::ChipATMega88(const std::string &deviceSpecification) {
	using namespace ATMega88;
	...
	if (std::string("A").compare(deviceSpecification)) {
		...
		this->setSignatureString("1E930A");

		//Set ATMega88 chip name
		this->setChipName("ATMEL ATMega88A");

	} else if (std::string("PA").compare(deviceSpecification)){
		//Set ATMega88 chip signature string
		this->setSignatureString("1E930F");

		//Set ATMega88 chip name
		this->setChipName("ATMEL ATMega88PA");
	}
	else {
		//Set ATMega88 chip signature string
		this->setSignatureString("1E930A");
		...
		//Set ATMega88 chip name
		this->setChipName("ATMEL ATMega88");
	}
}

ChipATMega88::~ChipATMega88() {	
}

InterfaceClass::ChipIF *ChipATMega88::createInstance(const std::string &deviceSpecification) {
	return new ChipATMega88(deviceSpecification);
}

bool ChipATMega88::compareWithFile(const char* filename) {
	return false;
}

bool ChipATMega88::compareWithChip(ChipIF& otherChip) {
	return false;
}

string ChipATMega88::getFactoryNameReference() {
	return "ATMEGA88";
}
