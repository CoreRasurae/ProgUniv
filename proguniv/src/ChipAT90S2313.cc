...
ChipAT90S2313::ChipAT90S2313(const std::string &deviceSpecification) {
	using namespace AT90S2313;
	...
	progPropPtr = shared_ptr<Property>(new Property( this, "minVddTwd_erase", "18500", "The amount of time required to erase memory at minimun Vdd voltage", true ));
	progPropPtr->addAcceptedValue( "18500", "18.5 ms" );
	this->addProgrammerProperty( progPropPtr );
	...
	this->setSignatureString("1E9101");
	
	//Set ATTiny461 chip name
	this->setChipName("ATMEL AT90S2313");
}


ChipAT90S2313::~ChipAT90S2313() {	
}

InterfaceClass::ChipIF *ChipAT90S2313::createInstance(const std::string &deviceSpecification) {
	return new ChipAT90S2313(deviceSpecification);
}

bool ChipAT90S2313::compareWithFile(const char* filename) {
	return false;
}

bool ChipAT90S2313::compareWithChip(ChipIF& otherChip) {
	return false;
}

string  ChipAT90S2313::getFactoryNameReference() {
	return "AT90S2313";
}
