...
namespace ATMega328 {
	//Handle ATMega88/88A/88PA,ATMega168/168A/168PA,ATMega328/328P Fuses for Lock Bit Byte fuses
	...
	//Handle ATMega328/328P Fuse High Byte Bits 2,1 and 0
	...
	//Handle ATMega328/328P Fuse Extended Byte
...
ChipATMega328::ChipATMega328(const std::string &deviceSpecification) {
	using namespace ATMega328;

	//Add chip memories
	shared_ptr<Memoria> memPtr =  shared_ptr<Memoria>(new Memoria(16384, 0x0000, 16, "Program"));
	...
	if (std::string("P").compare(deviceSpecification) == 0) {
		//Set ATMega328P chip signature string
		this->setSignatureString("1E950F");

		//Set ATMega328P chip signature string
		this->setChipName("ATMEL ATMega328P");
	}
	else {
		//Set ATMega328 chip signature string
		this->setSignatureString("1E950D");

		//Set ATMega328 chip name
		this->setChipName("ATMEL ATMega328");
	}
}

ChipATMega328::~ChipATMega328() {

}

InterfaceClass::ChipIF *ChipATMega328::createInstance(const std::string &deviceSpecification) {
	return new ChipATMega328(deviceSpecification);
}

bool ChipATMega328::compareWithFile(const char* filename) {
	return false;
}

bool ChipATMega328::compareWithChip(ChipIF& otherChip) {
	return false;
}

string ChipATMega328::getFactoryNameReference() {
	return "ATMEGA328";
}
