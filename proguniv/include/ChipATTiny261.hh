...
#ifndef CHIPATTINY261_HH_
#define CHIPATTINY261_HH_

#include "../include/ChipIF.hh"
#include "../include/ChipATTinyx61.hh"

/**
 * The implementation with the ATMEL AVR ATTiny261 characteristics
 * Abstract representation of the chip memories and configuration parameters 
 */
class ChipATTiny261 : public ChipATTinyx61 {
	public:
	...
	protected:
		ChipATTiny261(const std::string &deviceSpecification);
        
		virtual bool compareWithFile(const char* filename);
		virtual bool compareWithChip(ChipIF& otherChip);

	private:
    	ChipATTiny261& operator=(const ChipATTiny261& rhs);
};


#endif /* CHIPATTINY261_HH_ */
