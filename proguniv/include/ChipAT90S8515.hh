...
#ifndef CHIPAT90S8515_HH_
#define CHIPAT90S8515_HH_
 ...
 */
class ChipAT90S8515 : public Chip {
	public:
	...
	protected:
		ChipAT90S8515(const std::string &deviceSpecification);
        
		virtual bool compareWithFile(const char* filename);
		virtual bool compareWithChip(ChipIF& otherChip);

	private:
    	ChipAT90S8515& operator=(const ChipAT90S8515& rhs);
};


#endif /* CHIPAT90S8515_HH_ */
