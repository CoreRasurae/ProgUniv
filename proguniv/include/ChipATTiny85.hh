...
#ifndef CHIPATTINY85_HH_
#define CHIPATTINY85_HH_

#include "../include/ChipIF.hh"
#include "../include/ChipATTinyx5.hh"

/**
 * The implementation with the ATMEL AVR ATTiny85 characteristics
 * Abstract representation of the chip memories and configuration parameters 
 */
class ChipATTiny85 : public ChipATTinyx5 {
	public:
	...
	protected:
		ChipATTiny85(const std::string &deviceSpecification);
        
		virtual bool compareWithFile(const char* filename);
		virtual bool compareWithChip(ChipIF& otherChip);

	private:
    	ChipATTiny85& operator=(const ChipATTiny85& rhs);
};


#endif /* CHIPATTINY85_HH_ */
